    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("show", models.BooleanField(default=False, verbose_name="Published")),
                (
                    "answer_text",
                    models.TextField(
                        blank=True,
                        help_text="Bei den Antworten funktioniert auch HTML-Syntax!<br> Aus Gründen des verwendeten CSS-Frameworks muss der Tag <strong>&lt;ul&gt;</strong> die CSS-Klasse <em>browser-default</em> besitzen!",
                        verbose_name="Answer",
                    ),
                ),
                (
